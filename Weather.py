#Description: The program asks for information on the weather (temperature, wind speed, wind direction) and returns the numerical values as well as a verbal description ('warm', 'windy'), based on predetermined thresholds. 
